...
const About = () => (
  <div className="about-container">
    <div className="d-flex flex-column m-0 p-4 black-translucid w-100">
      <h1 className="fs-1 text-white text-center">About</h1>
      <p className="fs-4 text-white">
        <img className="about-image float-end m-2 p-2" src={developerImg} alt="" />
      ...
      <p className="fs-4 text-white">
        <img className="about-image float-start m-2 p-2" src={teamImg} alt="" />
